...
MODULE Class_Module_TimeManager
 USE Constants, Only: InitClassModuleConstants,r8, r4, i4, nfprt,unit_namelist
 IMPLICIT NONE
 PRIVATE
...
CONTAINS
 SUBROUTINE Init_Class_Module_TimeManager()
  IMPLICIT NONE
  NAMELIST /TimeControl/ idatei,idatec,idatef,DHFCT,dt_step,ICtrDay
  ...
  read(unit_namelist, nml=TimeControl)
